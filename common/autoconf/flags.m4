...
[
  ...
  $2COMMON_CCXXFLAGS_JDK="[$]$2COMMON_CCXXFLAGS_JDK \
      ...
      -I${SRC_ROOT}/src/java.base/$OPENJDK_$1_OS/native/include \
      -I${SRC_ROOT}/src/java.base/$OPENJDK_$1_OS_TYPE/native/include \
      -I${SRC_ROOT}/src/java.base/share/native/libjava \
      -I${SRC_ROOT}/src/java.base/$OPENJDK_$1_OS_TYPE/native/libjava"
